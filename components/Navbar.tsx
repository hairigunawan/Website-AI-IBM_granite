    ...
    <header className="absolute inset-x-0 p-6">
      <nav className="flex items-center font-stretch-90% justify-between lg:px-8 h-full">
        ...
        <div className="flex lg:flex-1">
          {/* Gabungkan ikon dan teks ke dalam satu tautan (<a>) */}
          <a href="/" className="-m-1.5 p-1.5 flex items-center gap-2 bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          ...
          >
            <span className="flex rounded-full text-sm px-5 font-stretch-50% items-center text-white transition">
